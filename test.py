...
def show_warning_window():
    ...
    if result == 'yes':
        ...
        # Perform the action when 'No' is clicked or the main_window is closed
        print("Cancelled")

# Create the main Tkinter main_window
root = tk.Tk()
root.title("Tkinter Warning Window Example")

# Create a button that will trigger the warning main_window
